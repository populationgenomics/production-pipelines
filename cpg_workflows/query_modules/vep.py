...
def vep_json_to_ht(vep_results_paths, out_path, use_110: bool = False):
    """
    ...
    if use_110:
        json_schema = (
            'Struct{minimised:Int32,assembly_name:String,allele_string:String,ancestral:String,'
            ...
            'exac_sas_allele:String,exac_sas_maf:Float64,id:String,minimised:Int32,'
            ...
            'swissprot:Array[String],transcript_id:String,trembl:Array[String],'
            'tsl:Int32,uniparc:Array[String],variant_allele:String,am_class:String,'
            'am_pathogenicity:Float64,source:String,flags:Array[String]}],variant_class:String}'
        )
    else:
        json_schema = (
