...
def cli_main():
    ...
    main(vcf_path=args.input, output_path=args.output, gene_bed=args.gene_bed, alpha_m=args.am)


def main(vcf_path: str, output_path: str, gene_bed: str, alpha_m: str | None = None):
    """
