...
class FilterWham(MultiCohortStage):
    ...
    def queue_jobs(self, multicohort: MultiCohort, inputs: StageInput) -> StageOutput:
        ...
        job.image(image_path('bcftools', '1.16')).cpu(1).memory('highmem').storage('20Gi')
...
class SpiceUpSVIDs(MultiCohortStage):
    ...
    def queue_jobs(self, multicohort: MultiCohort, inputs: StageInput) -> StageOutput:
        ...
        bcftools_job.image(image_path('bcftools', '1.16'))
...
class SplitAnnotatedSvVcfByDataset(DatasetStage):
    ...
    def queue_jobs(self, dataset: Dataset, inputs: StageInput) -> StageOutput:
        ...
        job.image(image_path('bcftools_120', '1.20'))  # FIXME
