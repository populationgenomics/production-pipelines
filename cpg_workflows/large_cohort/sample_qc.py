...
def run(vds_path: str, out_sample_qc_ht_path: str, tmp_prefix: str):
    ...
    sqc_ht_path = to_path(tmp_prefix) / 'Xref_Yref_norm_aneu_changed_sample_qc.ht'
...
def impute_sex(
    ...
    """
    checkpoint_path = tmp_prefix / 'sample_qc' / 'Xref_Yref_norm_aneu_changed_sex.ht'
    ...
    sex_ht = annotate_sex(
        vds,
        tmp_prefix=str(tmp_prefix / 'Xref_Yref_norm_aneu_changed_annotate_sex'),
