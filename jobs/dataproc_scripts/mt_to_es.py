...
class HailElasticsearchClient:
    ...
    def create_or_update_mapping(
        ...
        if _meta:
            logging.info('==> index _meta: ' + pformat(_meta))
    ...
    def _update_settings(self, index_name, body):
        logging.info('==> Setting {} settings = {}'.format(index_name, body))
    ...
    def export_table_to_elasticsearch(
        ...
        if ignore_elasticsearch_write_errors:
            ...
            elasticsearch_config[
                'es.write.rest.error.handler.log.logging.name'
            ] = 'BulkErrors'
        ...
        if field_name_to_elasticsearch_type_map is not None:
            ...
            for (
                ...
                logging.info(f'{match_count} columns matched "{field_name_regexp}"')
