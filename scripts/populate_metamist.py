...
def main(command: str, config_paths: list[str]):
    ...
    if command == 'es-index':
        ...
        if sequencing_type == 'genome':
            names = [
                'ag-hidden-genome-2022_1111_1947_54vza',
                'mito-disease-genome-2022_1113_1641_4xt4v',
                'ravenscroft-rdstudy-genome-2022_1113_1641_4xt4v',
                'perth-neuro-genome-2022_1113_1641_4xt4v',
            ]
