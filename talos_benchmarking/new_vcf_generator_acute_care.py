...
tmp_dir = 'gs://cpg-acute-care-test-tmp/talos_benchmarking/acute-care_ms_vcfs'
output_ms_vcfs = 'gs://cpg-acute-care-test/talos_benchmarking/acute-care_ms_vcfs'
...
for chunk_num, sg_chunk in enumerate(utils.chunks(samples, 50)):
