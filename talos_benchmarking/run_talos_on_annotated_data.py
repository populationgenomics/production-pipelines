...
# the pedigree and phenopackets files, combined across 2 datasets
pedigree = 'gs://cpg-seqr-test/talos_benchmarking/pedigree.ped'
phenopackets = 'gs://cpg-seqr-test/talos_benchmarking/phenopackets.json'
...
# input directory, containing a combination of acute-care and ghfm-kidgen data
input_dir = 'gs://cpg-acute-care-test/talos_benchmarking/new_trimmed_ms_merged_results_new_final'

for each_group in [5, 10, 25, 50, 100, 250, 375, 600, 1000]:

    output_path = f'gs://cpg-seqr-test/talos_benchmarking/massive_merge_results/{each_group}'
    ...
    new_job = batch_instance.new_bash_job(f'Run Talos for {each_group} sample VCF')
    new_job.image(image)
