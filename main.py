...
from cpg_workflows.stages.gatk_sv import ClusterBatch, GatherBatchEvidence, GenerateBatchMetrics, FilterBatch
...
WORKFLOWS: dict[str, list[StageDecorator]] = {
    ...
    'gatk_sv': [GatherBatchEvidence, ClusterBatch, GenerateBatchMetrics, FilterBatch],
}
