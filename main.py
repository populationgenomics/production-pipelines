...
from cpg_workflows.stages.large_cohort import AncestryPlots, Frequencies, LoadVqsr, PrepareBrowserTable
...
WORKFLOWS: dict[str, list[StageDecorator]] = {
    ...
    'large_cohort': [LoadVqsr, Frequencies, AncestryPlots, GvcfMultiQC, CramMultiQC, PrepareBrowserTable],
