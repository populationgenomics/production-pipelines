...
from cpg_workflows.stages.large_cohort import LoadVqsr, Frequencies, AncestryPlots, DenseSubset
...
WORKFLOWS: dict[str, list[StageDecorator]] = {
    ...
    'seqr_loader': [AnnotateDataset, MtToEs, GvcfMultiQC, CramMultiQC, Stripy, DenseSubset],
