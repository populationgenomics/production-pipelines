...
cram = 'gs://cpg-tob-wgs-test/pipeline_validation/kccg_gatk4/cram/v0/HG01513.cram'
...
expected_out = {
    'vcf': to_path(output_path('HG01513.vcf.gz')),
    'index': to_path(output_path('HG01513.vcf.gz.tbi'))
}
