...
def get_intervals(
    ...
    """
    if scatter_count in ref_data.PRECOMPUTED_INTERVALS:
        intervals_bucket = ref_data.PRECOMPUTED_INTERVALS[scatter_count]
    ...
    -L {ref_data.UNPADDED_INTERVALS} \\
    -O {j.intervals} \\
    -scatter {scatter_count} \\
    -R {ref_data.REF_FASTA} \\
